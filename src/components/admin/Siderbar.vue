      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          ...
          <ul class="nav flex-column a-nav">
            <li class="nav-item">
              <router-link to="/admin/products" class="nav-link d-flex justify-content-around">
                <svg
            ...
            <li class="nav-item">
              <router-link to="/admin/orders" class="nav-link d-flex justify-content-around">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <li class="nav-item">
              <router-link to="/admin/brands" class="nav-link d-flex justify-content-around">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
